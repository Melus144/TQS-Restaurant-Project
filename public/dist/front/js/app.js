...
/***/ "./resources/js/utilities/accordion.js":
/*!*********************************************!*\
  !*** ./resources/js/utilities/accordion.js ***!
  \*********************************************/
/***/ (() => {
...
var accordionMenu = function accordionMenu() {
  ...
  document.addEventListener('click', function (event) {
    ...
    if (!trigger) return; // Get the target content

    var target = document.querySelector(trigger.hash);
    if (!target) return; // Prevent default link behavior

    event.preventDefault(); // Toggle our content

    target.classList.toggle('accordion-menu--hidden');
    trigger.previousElementSibling.classList.toggle('accordion-menu--hidden'); // Toggle trigger class

    trigger.classList.toggle('accordion-menu--active');
    trigger.previousElementSibling.classList.toggle('accordion-menu--active');
  }); // Listen for click on the document
  ...
  document.addEventListener('click', function (event) {
    ...
    event.preventDefault(); // If the content is already expanded, collapse it and quit
...
/* harmony import */ var flickity_bg_lazyload__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flickity-bg-lazyload */ "./node_modules/flickity-bg-lazyload/bg-lazyload.js");
/* harmony import */ var flickity_bg_lazyload__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flickity_bg_lazyload__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _utilities_accordion_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities/accordion.js */ "./resources/js/utilities/accordion.js");
/* harmony import */ var _utilities_accordion_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_utilities_accordion_js__WEBPACK_IMPORTED_MODULE_2__);
...
window.Flickity = __webpack_require__(/*! flickity-imagesloaded */ "./node_modules/flickity-imagesloaded/flickity-imagesloaded.js");
